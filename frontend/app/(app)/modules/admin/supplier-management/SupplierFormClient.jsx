...
import { Save, ArrowLeft, RotateCcw, Building2, User, Phone, Mail, MapPin, ShieldCheck, Tag, Calendar, CreditCard, FileText, Star } from "lucide-react";
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        setForm({
                            ...
                            contractStatus: supplier.contractStatus || "ACTIVE",
                            ...
                            rating: {
                                deliverySpeed: supplier.rating?.deliverySpeed || 5,
                                quality: supplier.rating?.quality || 5,
                                communication: supplier.rating?.communication || 5,
                                pricing: supplier.rating?.pricing || 5
                            }
                        });
                    }
                } catch (error) {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="h-14 w-full rounded-2xl border border-white/10 bg-white/5 px-6 text-lg text-white shadow-inner outline-none focus:border-[#408c8c] focus:ring-4 focus:ring-[#408c8c]/10 transition-all cursor-pointer appearance-none"
                                    >
                                        <option value="Vegetables" className="bg-[#011627]">Vegetables</option>
                                        <option value="Meat" className="bg-[#011627]">Meat</option>
                                        <option value="Dairy" className="bg-[#011627]">Dairy</option>
                                        <option value="Spices" className="bg-[#011627]">Spices</option>
                                        <option value="Beverages" className="bg-[#011627]">Beverages</option>
                                        <option value="Seafood" className="bg-[#011627]">Seafood</option>
                                        <option value="Grains" className="bg-[#011627]">Grains</option>
                                        <option value="Other" className="bg-[#011627]">Other</option>
                                    </select>
                                    <div className="absolute right-6 top-1/2 -translate-y-1/2 pointer-events-none text-slate-500">
                                        <RotateCcw className="w-4 h-4 rotate-90" />
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="h-14 w-full rounded-2xl border border-white/10 bg-white/5 px-6 text-lg text-white shadow-inner outline-none focus:border-[#408c8c] focus:ring-4 focus:ring-[#408c8c]/10 transition-all cursor-pointer appearance-none"
                                    >
                                        <option value="Net 30" className="bg-[#011627]">Net 30</option>
                                        <option value="Net 60" className="bg-[#011627]">Net 60</option>
                                        <option value="Net 90" className="bg-[#011627]">Net 90</option>
                                        <option value="COD" className="bg-[#011627]">COD (Cash on Delivery)</option>
                                        <option value="Advance Payment" className="bg-[#011627]">Advance Payment</option>
                                        <option value="Other" className="bg-[#011627]">Other</option>
                                    </select>
                                    <div className="absolute right-6 top-1/2 -translate-y-1/2 pointer-events-none text-slate-500">
                                        <RotateCcw className="w-4 h-4 rotate-90" />
                            ...
                            <div className="space-y-4">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setField("contractExpiryDate", e.target.value)}
                                    className="h-14 rounded-2xl border-white/10 bg-white/5 focus:border-[#408c8c] focus:ring-[#408c8c]/20 text-white placeholder:text-white/40 text-lg shadow-inner"
                                />
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setField("businessRegistrationNo", e.target.value)}
                            ...
                            <div className="space-y-6 md:col-span-2 mt-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <label className="text-xs font-black uppercase tracking-[0.2em] text-gray-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white/5 p-8 rounded-3xl border border-white/10">
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-sm font-semibold text-gray-300">Delivery Speed</label>
                                        <div className="flex items-center gap-4">
                                            <input
                                                type="range"
                                                min="1"
                                                max="5"
                                                value={form.rating.deliverySpeed}
                                                onChange={(e) => setForm(prev => ({
                                                    ...prev,
                                                    rating: { ...prev.rating, deliverySpeed: parseInt(e.target.value) }
                                                }))}
                                            ...
                                            <div className="flex items-center gap-1 min-w-[80px]">
                                                {[...Array(5)].map((_, i) => (
                                                    <Star
                                                        key={i}
                                                        className={`w-4 h-4 ${i < form.rating.deliverySpeed ? 'fill-yellow-400 text-yellow-400' : 'text-gray-600'}`}
                                                    />
                                                ))}
                                            </div>
                                        </div>
                                    ...
                                    {/* Quality */}
                                    <div className="space-y-3">
                                        <label className="text-sm font-semibold text-gray-300">Product Quality</label>
                                        <div className="flex items-center gap-4">
                                            <input
                                                type="range"
                                                min="1"
                                                max="5"
                                                value={form.rating.quality}
                                                onChange={(e) => setForm(prev => ({
                                                    ...prev,
                                                    rating: { ...prev.rating, quality: parseInt(e.target.value) }
                                                }))}
                                                className="flex-1 h-2 bg-white/10 rounded-lg appearance-none cursor-pointer accent-yellow-400"
                                            />
                                            <div className="flex items-center gap-1 min-w-[80px]">
                                                {[...Array(5)].map((_, i) => (
                                                    <Star
                                                        key={i}
                                                        className={`w-4 h-4 ${i < form.rating.quality ? 'fill-yellow-400 text-yellow-400' : 'text-gray-600'}`}
                                                    />
                                                ))}
                                            </div>
                                        </div>
                                    ...
                                    {/* Communication */}
                                    <div className="space-y-3">
                                        <label className="text-sm font-semibold text-gray-300">Communication</label>
                                        <div className="flex items-center gap-4">
                                            <input
                                                type="range"
                                                min="1"
                                                max="5"
                                                value={form.rating.communication}
                                                onChange={(e) => setForm(prev => ({
                                                    ...prev,
                                                    rating: { ...prev.rating, communication: parseInt(e.target.value) }
                                                }))}
                                                className="flex-1 h-2 bg-white/10 rounded-lg appearance-none cursor-pointer accent-yellow-400"
                                            />
                                            <div className="flex items-center gap-1 min-w-[80px]">
                                                {[...Array(5)].map((_, i) => (
                                                    <Star
                                                        key={i}
                                                        className={`w-4 h-4 ${i < form.rating.communication ? 'fill-yellow-400 text-yellow-400' : 'text-gray-600'}`}
                                                    />
                                                ))}
                                            </div>
                                        </div>
                                    ...
                                    {/* Pricing */}
                                    <div className="space-y-3">
                                        <label className="text-sm font-semibold text-gray-300">Pricing</label>
                                        <div className="flex items-center gap-4">
                                            <input
                                                type="range"
                                                min="1"
                                                max="5"
                                                value={form.rating.pricing}
                                                onChange={(e) => setForm(prev => ({
                                                    ...prev,
                                                    rating: { ...prev.rating, pricing: parseInt(e.target.value) }
                                                }))}
                                                className="flex-1 h-2 bg-white/10 rounded-lg appearance-none cursor-pointer accent-yellow-400"
                                            />
                                            <div className="flex items-center gap-1 min-w-[80px]">
                                                {[...Array(5)].map((_, i) => (
                                                    <Star
                                                        key={i}
                                                        className={`w-4 h-4 ${i < form.rating.pricing ? 'fill-yellow-400 text-yellow-400' : 'text-gray-600'}`}
                                                    />
                                                ))}
                                            </div>
                                        </div>
